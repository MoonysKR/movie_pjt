          ...
          <div class="col-8 content row align-items-center second">
            <div class="second-box">
              <!-- <div class="col-4 align-items-center"> -->
                ...
                <!-- <img v-if="!spoiler" src="../images/꿀벌.png" class="bee-img" sizes="(max-width: 4px) 1px" alt="">
                <img v-if="spoiler" src="../images/말벌.png" class="bee-img" sizes="(max-width: 4px) 1px" alt=""> -->
              <!-- </div> -->
            </div>
            <!-- <div class="col-8 blank">
            </div> -->
              <div v-if="spoiler">
...
const API_KEY = 'AIzaSyBM7Vge5dZEJ6JrqsIhe9LH6drGP0bSseM'
